"""
# Optim_gf.jl
Welcome to Optim_gf.jl!

Optim_gf.jl is a package used to solve continuous optimization problems. It is
...
## REPL help
`?` followed by an algorithm name (`?BFGS`), constructors (`?Optim_gf.Options`)
prints help to the terminal.

## Documentation
Besides the help provided at the REPL, it is possible to find help and general
documentation online at http://julianlsolvers.github.io/Optim_gf.jl/stable/ .
"""
module Optim_gf
