...
## Description
The Particle Swarm implementation in Optim_gf.jl is the so-called Adaptive Particle
...
reaches the maximum number of iterations set in Optim_gf.Options(iterations=x)`.
